...
const INITIAL_CONVERSATIONS: Conversation[] = [
  ...
  },
  {
    ...
    name: "Sarah Miller",
    platform: "instagram",
    lastMessage: "The new collection looks amazing!",
  ...
  },
  {
    ...
    name: "Tech Support",
    platform: "telegram",
    lastMessage: "Your ticket #4452 has been resolved.",
...
const INITIAL_MESSAGES: Record<string, Message[]> = {
  "1": [
    { id: "m1", sender: "Alex Johnson", content: "Hey! How's the MVP coming along?", timestamp: new Date(Date.now() - 100000), type: "incoming", kind: "text", sentiment: 'positive' },
    { id: "m2", sender: "You", content: "Going great! Just polishing the UI now.", timestamp: new Date(Date.now() - 80000), type: "outgoing", kind: "text", starred: true, sentiment: 'positive' },
    { id: "m3", sender: "Alex Johnson", content: "Nice. Can't wait to see the 'fashion' aesthetic you mentioned.", timestamp: new Date(Date.now() - 60000), type: "incoming", kind: "text", sentiment: 'positive' },
    { id: "m4", sender: "Alex Johnson", content: "Voice message for feedback", timestamp: new Date(Date.now() - 30000), type: "incoming", kind: "audio", starred: true },
    { id: "m5", sender: "Alex Johnson", content: "Looking forward to our meeting tomorrow!", timestamp: new Date(Date.now() - 10000), type: "incoming", kind: "text" },
  ],
  "2": [
    { id: "s1", sender: "Sarah Miller", content: "The new collection looks amazing!", timestamp: new Date(Date.now() - 3600000), type: "incoming", kind: "text" },
    { id: "s2", sender: "Sarah Miller", content: "Attached the moodboard idea.", timestamp: new Date(Date.now() - 3500000), type: "incoming", kind: "image", mediaUrl: "https://images.unsplash.com/photo-1523381210434-271e8be1f52b?auto=format&fit=crop&w=800&q=80" },
  ],
  "3": [
    { id: "t1", sender: "Tech Support", content: "Your ticket #4452 has been resolved.", timestamp: new Date(Date.now() - 7200000), type: "incoming", kind: "text" },
  ]
};
...
export default function InboxPage() {
  ...
  const handleSendMessage = (textOverride?: string) => {
    ...
    setTimeout(() => {
      ...
      // Simulate delivery after a bit more time
      setTimeout(() => {
        setMessages(prev => ({
          ...prev,
          [activeChatId]: prev[activeChatId].map(m => 
  ...
  return (
    <div 
      ...
      style={{ 
        gridTemplateColumns: `${leftSidebarWidth}px minmax(350px, 1fr) ${showRightSidebar ? `${rightSidebarWidth}px` : '0px'}` 
      }}
    >
      ...
      {/* Chat Detail Column */}
      <section className="grid grid-rows-[80px_1fr_auto] h-full overflow-hidden bg-[#0c0c0e] relative min-w-0 z-20 shadow-[0_0_50px_rgba(0,0,0,1)]">
        {/* Chat Header */}
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-zinc-900 border border-white/10 flex items-center justify-center overflow-hidden">
                {activeChat.platform === 'whatsapp' && <MessageSquare className="w-3 h-3 text-green-500 fill-current" />}
                {activeChat.platform === 'instagram' && <Instagram className="w-3 h-3 text-pink-500" />}
                {activeChat.platform === 'telegram' && <Send className="w-3 h-3 text-blue-500 fill-current" />}
              </div>
            </div>
            <div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[11px] text-zinc-400 leading-relaxed mb-4">
                        Alex is asking about order tracking. Our **Support Flow** can resolve this in <span className="text-primary font-bold">12 seconds</span>. Should I proceed or wait for a specialist?
                      </p>
                      <div className="flex gap-2">
                        <Button 
                          size="sm" 
